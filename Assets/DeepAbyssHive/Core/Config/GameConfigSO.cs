...
namespace DeepAbyssHive.Core.Config
{
    ...
    public partial class GameConfigSO : ScriptableObject
    {
        ...
        [Tooltip("建築旋轉：向左旋轉（逆時針）")]
        public KeyCode buildingRotateLeftKey = KeyCode.Q;
        [Tooltip("建築旋轉：向右旋轉（順時針）")]
        public KeyCode buildingRotateRightKey = KeyCode.E;
        ...
        [Header("Placement Auto-Start Control")]
        [Tooltip("是否允許建築放置系統自動啟動（進入遊戲時自動進入放置模式）")]
        public bool placementAutoStart = false;
    }
